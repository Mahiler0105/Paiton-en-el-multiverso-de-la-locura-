export default class Loading extends Phaser.Scene {
    ...
    create(){
        ...
        this.anims.create({ key: "charge", frames: this.anims.generateFrameNames("loading", { prefix: "l", start: 1, end: 3, suffix: ".png"}), frameRate: 2 });
        ...
        setTimeout(() => {   
            ...
            setTimeout(() => { this.scene.switch('Bootloader') }, 500);   
